...
using Business.Services.TrendyolService.Concrete;
...
namespace Business
{
    public partial class BusinessStartup
    {
        ...
        public void ConfigureDevelopmentServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ITrendyolProductRepository, TrendyolProductRepository>();
        ...
        public void ConfigureStagingServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ITranslateRepository, TranslateRepository>();
            services.AddTransient<ILanguageRepository, LanguageRepository>();
            services.AddTransient<ITrendyolService, TrendyolService>();
