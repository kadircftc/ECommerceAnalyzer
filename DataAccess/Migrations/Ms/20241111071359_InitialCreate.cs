    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrendyolProductImageses", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TrendyolProductLastSocialProoves",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrendyolProductLastSocialProoves", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryHierarchy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    SameDayShipping = table.Column<bool>(type: "bit", nullable: false),
                    PriceLabelName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PriceLabelValue = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    RatingTotalCount = table.Column<int>(type: "int", nullable: false),
                    ...
                    RushDeliveryDuration = table.Column<int>(type: "int", nullable: false),
                    ...
                    WinnerVariant = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrendyolProductTags", x => x.Id);
                });
